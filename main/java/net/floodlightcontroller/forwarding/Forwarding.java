...
import net.floodlightcontroller.crana.ReservationService;
...
public class Forwarding extends ForwardingBase implements IFloodlightModule, IOFSwitchListener {
	...
	protected void preProcess(IOFSwitch sw, OFPacketIn pi, FloodlightContext cntx, boolean requestFlowRemovedNotifn) {
		...
		if (dstDevice != null) {
			...
			//System.out.println("now Preprocess---------------");
			/** 属于预留的就用我们的算法计算路，否则用一般的forwarding，根据跳数*/
	...
	public void init(FloodlightModuleContext context) throws FloodlightModuleException {
		...
		this.reservationService = context.getServiceImpl(ReservationService.class);
